...
export default function OrdersPage() {
  ...
  // Sécurité : empêcher accès si non connecté
  if (!isAuthenticated) {
  ...
  if (orders.length === 0) {
    return (
      <div className="text-center py-12 animate-fadeIn">
        ...
        <p className="text-muted mb-8">Vous n'avez pas encore de commandes</p>

        <Link
          to="/menu"
          className="inline-block bg-[var(--color-primary)] text-white px-6 py-3 rounded-lg hover:bg-[var(--color-primary-light)] transition"
        >
